...
export const ItemCard = memo(function ItemCard({ item, onClick }) {
  return (
  <button
...
export const ItemRow = memo(function ItemRow({ item, onClick }) {
  return (
  <div
...
export const ItemTimelineEntry = memo(function ItemTimelineEntry({ item, onClick }) {
  return (
  <div
    className={cn(
...
ItemTimelineEntry.displayName = 'ItemTimelineEntry';
