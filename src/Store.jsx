...
// Task types for songs - per APP_ARCHITECTURE.md Section 3.1 and 3.2
...
// Stems-related tasks per APP_ARCHITECTURE.md Section 3.2
...
// Video task types - per APP_ARCHITECTURE.md Section 3.3 and Phase 1.8 specification
...
// Release task types - per APP_ARCHITECTURE.md Section 3.4 and Phase 3 specification
...
// Event task types - per APP_ARCHITECTURE.md Section 3.5
...
export const StoreProvider = ({ children }) => {
  ...
  const actions = {
     ...
     // Per APP_ARCHITECTURE.md Section 5.4: Event properties
    ...
    const newSong = propagateSongMetadata({
        ...
        // Writers and Composers per APP_ARCHITECTURE.md Section 5.1
    ...
    addVersionCustomTask: async (songId, versionId, task) => {
     ...
     // Per APP_ARCHITECTURE.md Section 1.4: Propagate Era changes to child Tasks and linked Items
    ...
    deleteSongVideoCustomTask: async (songId, videoId, taskId) => {
     ...
     // ============================================================
     // EXPENSE ITEM ACTIONS - Per APP_ARCHITECTURE.md Section 1.2
     ...
     // ============================================================
     // TASK CATEGORY ITEM ACTIONS - Per APP_ARCHITECTURE.md Section 1.2
